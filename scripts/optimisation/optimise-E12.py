...
from edo.optimisation.utils import find_experiment, load_train_test, load_predictions, load_shap_files, load_model, difference_list
...
if __name__ == "__main__":
    ...
    group_scores = {}
    for group_tr, group_te, name_tr, name_te in zip(groups_train_samples, groups_test_samples, group_train_names, group_test_names):
        ...
        rules_df.to_csv(osp.join(saving_dir, f'{timestamp}-{name_tr}-rules.csv'))
