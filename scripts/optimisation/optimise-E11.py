...
"""Controlling hparams for present features."""
...
if __name__ == "__main__":
    ...
    parser.add_argument('pf_ratio', type=float,
                        help='derive rules only for features which are present and absent in at least pf_ratio samples in training set')
    ...
    for group_tr, group_te, group_name in zip(groups_train_samples, groups_test_samples, group_names):
        ...
        group_scores[f'{group_name}_scores'] = group_results
